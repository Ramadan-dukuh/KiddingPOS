...
<head>
  ...
  <title>Register - POS Warung UMKM</title>
  ...
  <div class="relative z-10 w-full max-w-md">        
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 mx-2 mt-8">
      ...
      <a href="landing.php" class="inline-flex items-center text-gray-600 hover:text-primary transition-colors">
        ...
        <p class="text-gray-600">Buat akun POS Warung UMKM Anda</p>
      </div>
      ...
      <div class="text-center mt-6">
        <p class="text-gray-600">
          Sudah punya akun? 
          <a href="login.php" class="text-primary font-semibold hover:underline">Masuk sekarang</a>
        </p>
      </div>
